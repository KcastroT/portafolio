...
const Intro = () => {
  return (
    <div
      ...
      id="intro"
    >
      <div className="bg-white bg-opacity-90 rounded-lg shadow-lg p-8 max-w-2xl text-center text-gray-800">
        ...
        <img
          ...
          alt="Kevin Castro"
          className="rounded-full w-64 h-auto mx-auto mb-4 shadow-lg border-4 border-white transition-transform duration-300 hover:scale-105"
        />
